...
// Get the selected category and language, default to 'intermediate' and 'Python'
$category = isset($_GET['category']) ? $_GET['category'] : 'intermediate';
...
<head>
    ...
    <title>Repositories for Intermediate Developers</title>
...
<header>
    <div class="header-container">
        <h1>Top Repositories for Intermediate Developers</h1>
        <p>Explore the best repositories for intermediate-level developers.</p>
    </div>
</header>
